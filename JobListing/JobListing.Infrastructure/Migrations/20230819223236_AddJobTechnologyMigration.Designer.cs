...
namespace JobListing.Infrastructure.Migrations
{
    ...
    [Migration("20230819223236_AddJobTechnologyMigration")]
    partial class AddJobTechnologyMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobListing.Infrastructure.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobListing.Infrastructure.Models.Job", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobListing.Infrastructure.Models.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobListing.Infrastructure.Models.Company", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "CompanyUser")
                        .WithMany()
            ...
            modelBuilder.Entity("JobListing.Infrastructure.Models.Job", b =>
                {
                    b.HasOne("JobListing.Infrastructure.Models.Company", "Company")
                        .WithMany("Jobs")
            ...
            modelBuilder.Entity("JobListing.Infrastructure.Models.Technology", b =>
                {
                    b.HasOne("JobListing.Infrastructure.Models.Job", null)
